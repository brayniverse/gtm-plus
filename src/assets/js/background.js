...
;(function(window, document, undefined) {
	...
	var tagSearchInput   = document.createElement('input'),
	...
	function injectSearchFields() {
		...
		if ( ! tagListContainer || ! ruleListContainer || ! macroListContainer) {
			setTimeout(injectSearchFields, 2000);
		} else {
